...
Issue ページ内のリンク（本文・コメント中の参照、sub-issues など）をクリックしたとき、
GitHub Projects のようなスライドインのサイドパネルで Issue をプレビューする Chrome 拡張。
...
- Issues 一覧・Issue ページ内の Issue リンクをクリック → サイドパネルでプレビュー
